...
def create_fixture_zotero(root: Path) -> Path:
    ...
    conn.executescript(
        ...
        CREATE TABLE tags (tagID INTEGER PRIMARY KEY, name TEXT, type INTEGER);
    ...
    values = [(1, "OpenVLA"), (2, "2024-09-05"), (3, "arXiv"), (4, "10.48550/arXiv.2406.09246"), (5, "Abstract")]
    ...
    conn.executemany("INSERT INTO tags VALUES (?, ?, 0)", [(1, "★★★★★"), (2, "#VLA/端到端"), (3, "#有代码"), (4, "CCF-A"), (5, "/done")])
